...
<li class="treeview">
  ...
  <ul class="treeview-menu">
    <li class="active"><a href="../../admin/index.html/adminIndex.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
  </ul>
</li>
```
  </div>
...
<li class="nav-item has-treeview">
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="../../admin/index.html/adminIndex.html" class="nav-link active">

...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="../../../../static/admin/dist/img/user2-160x160.jpg" class="img-circle elevation-2"
                     alt="User Image">
            </div>
            <div class="info">
...
<a href="#" class="brand-link logo-switch">
    <img src="../../../../static/admin/dist/img/logo-xs.png" alt="AdminLTE Docs Logo Small"
         class="brand-image-xl logo-xs">
    <img src="../../../../static/admin/dist/img/logo-xl.png" alt="AdminLTE Docs Logo Large"
